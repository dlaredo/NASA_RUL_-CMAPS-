...
other state-of-the-art methods. The methods chosen for the comparisson obey to two criteria: 1) that the method used is a machine learning (or statistical) method and 2) that the method is recent (6 years old at most). Most of the methods chosen to compare here 
